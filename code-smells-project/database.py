...
# REFACTORED: conexão por requisição via flask.g (corrige conexão global mutável
...
def _seed(conn):
    ...
    if cursor.fetchone()[0] == 0:
        ...
        # REFACTORED: senhas armazenadas como hash (corrige senha em texto puro)
        usuarios = [
...
def init_db():
    # REFACTORED: inicialização usa conexão própria (fora do contexto de request)
